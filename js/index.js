...
// 4 mousedown / logo message/background
...
// 6 wheel scroll,  on scroll funbus picture rotates 720 deg
...
// 8 context menu / turns background red
...
document.addEventListener('auxclick', (event) => {
    alert('I see you have some extra buttons on your mouse.');
});
